...
`client-sdk` is a TypeScript-based project within ORGAN-II (Poiesis) of the organvm eight-organ creative-institutional system. The project needed a technology foundation that balances rapid prototyping with long-term maintainability, aligning with the organ system's emphasis on portfolio-quality engineering.
...
- Node.js version matrix (18/20/22) increases CI time
